 ...
 * is provided to an {@link Analyzer} function which can be implemented by application
...
public final class ImageAnalysis extends UseCase {
     ...
     * format {@link ImageFormat#YUV_420_888}
     *
     ...
     *
     * <p>All {@link ImageProxy} sent to {@link Analyzer#analyze(ImageProxy)} will have
     * format {@link PixelFormat#RGBA_8888}
     *
     * @see Builder#setOutputImageFormat(int)
     */
     ...
     * {@link Builder#setTargetRotation(int)}, or dynamically by calling
     ...
     * {@link Builder#setTargetResolution(Size)} will be updated automatically to
     ...
     *                 {@link Analyzer#analyze(ImageProxy)} will be run.
     ...
     * {@link Builder#setBackpressureStrategy(int)}. If not set, it defaults to
     ...
     * {@link Builder#setImageQueueDepth(int)}. If not set, and this option is used
     ...
     * {@link Analyzer#analyze(ImageProxy)} function.
     */
    @RequiresApi(21) // TODO(b/200306659): Remove and replace with annotation on package-info.java
    public interface Analyzer {
         ...
         * {@link Builder#setBackpressureStrategy(int)}.
         *
         ...
         *
         * <p>The image provided has format {@link ImageFormat#YUV_420_888}.
         *
    ...
    public static final class Builder
         ...
         * Analyzer#analyze(ImageProxy)}. Increasing the image queue depth
         ...
         * case.  See
         * {@link ImageAnalysis#setTargetRotation(int)} for additional
         * documentation.
         *
