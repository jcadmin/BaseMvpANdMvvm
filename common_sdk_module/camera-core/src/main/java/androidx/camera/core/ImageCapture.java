 ...
 * via an {@link OnImageCapturedCallback}.
 */
...
public final class ImageCapture extends UseCase {
     ...
     * {@link Builder#setTargetResolution(Size)} will be updated automatically to make
     ...
     * {@link Builder#setCaptureMode(int)}. This is static for an instance of
     * ImageCapture.
     */
    @CaptureMode
     ...
     *
     * <p>This is set when constructing an ImageCapture using
     * {@link Builder#setJpegQuality(int)}. If not set, a default value will be set
    ...
    public static final class Builder implements
         ...
         * case.  See {@link ImageCapture#setTargetRotation(int)} for
         * additional documentation.
         *
         * <p>If not set, the target rotation will default to the value of
         * {@link Display#getRotation()} of the default display at the time the use
         ...
         * OnImageSavedCallback)}. If no executor is set, then a default Executor
