...
public final class Preview extends UseCase {
     ...
     *
     * <p>While rotation can also be set via {@link Builder#setTargetRotation(int)}
     ...
     * @see Builder#setTargetRotation(int)
     */
     ...
     * {@link Builder#setTargetRotation(int)}. If not set, the target rotation defaults to
    ...
    public interface SurfaceProvider {
         ...
         *
         * {@linkplain SurfaceRequest#provideSurface(Surface, Executor, Consumer)
         ...
         * invoked with a {@link SurfaceRequest.Result} containing
         * {@link SurfaceRequest.Result#RESULT_SURFACE_USED_SUCCESSFULLY}.
         *
         * Example:
         *
         * <pre>
