...
/**
 * Contains tests for {@link Camera2CameraImpl} internal
 * implementation.
 */
@LargeTest
...
public final class Camera2CameraImplTest {
    ...
    public void setup() throws Exception {
        mMockOnImageAvailableListener = Mockito.mock(OnImageAvailableListener.class);
    ...
    public static class TestUseCase extends FakeUseCase {
        private final OnImageAvailableListener mImageAvailableListener;
